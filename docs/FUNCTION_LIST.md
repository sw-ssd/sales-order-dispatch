...
| Logo/Branding/PublicInfo | 公開資訊 + Logo 上傳 | Web/後端 | 🟡（PublicInfo＋Logo 上傳/顯示已落地：`POST /companies/{id}/logo`（company_admin，限所屬公司）＋`GET /me`＋Web 上傳對話框/側邊欄；UpdateBranding／公開發現端點待） |
