...
> 對應：`docs/superpowers/specs/2026-07-16-sales-order-1.0-design.md`（v1.0.34）§2.1 / §9.6、`docs/superpowers/specs/2026-07-19-sales-order-1.0-decisions.md`（D1–D32）、`docs/superpowers/plans/reference/2026-07-17-sales-order-1-0-tasks.md`（v2.9.0）
