...
| 計畫 | 路徑 | 範圍 | 進度 | 狀態 | 依賴 |
|------|------|------|------|------|------|
| 主計畫 | `2026-08-05-…-subproject-implementation-plan.md` | 三子專案 50 Tasks / 5 Waves | 20/298 | 進行中（Wave 1 完成） | — |
| go8-alignment | `backend/2026-08-24-backend-go8-alignment-plan.md` | 後端結構對齊（D31） | 38/38 | ✅ 完成 | 無；須先於 01 實作 |
| casl-integration | `cross-cutting/2026-08-24-casl-integration-plan.md` | CASL 前後端整合 | 13/13 | ✅ 完成（T10 對齊 T18 形狀） | 無；須先於 01/02 實作 |
