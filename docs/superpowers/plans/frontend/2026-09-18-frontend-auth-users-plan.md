...
| 待辦 | 相依 |
|---|---|
| master-data 前端（客戶 `206192a`、商品 `61feab2`、車次 `e950b23` 已落地；地址簿/聯絡人/倉別/分類/分切規格待） | backend 04 ✅ 後端已落地 |
| ~~orders 前端~~ ✅ 已落地（`6953b02`） | backend 05 ✅ |
| ~~dispatch 看板前端~~ ✅ 已落地（`e3ed769`） | backend 08 ✅ |
| printing 前端 | backend 09 ✅ 後端已落地 |
| CASL → OpenFGA 遷移（UI 權限來源） | D32 定奪 |

---

*最後更新：2026-09-22（使用者管理頁 17/17 打勾；客戶 `206192a`、訂單 `6953b02`、商品 `61feab2`、派車看板 `e3ed769`、車次主檔 `e950b23`、單據列印 `13c76f4` 六頁落地；地址簿/退貨/通知/稽核頁待建，後端皆已就緒）*
