...
| 待辦 | 相依 |
|---|---|
| master-data 前端（客戶 `206192a` ＋ 商品 `61feab2` 已落地；地址簿/聯絡人/部門級主檔待） | backend 04 ✅ 後端已落地 |
...
*最後更新：2026-09-22（使用者管理頁 17/17 打勾；客戶 `206192a`、訂單 `6953b02`、商品 `61feab2`、派車看板 `e3ed769` 四頁落地；地址簿/退貨/列印/通知/稽核頁待建，後端皆已就緒）*
