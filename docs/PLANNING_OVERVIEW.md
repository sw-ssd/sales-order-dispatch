...
> 核心狀態：**monorepo；backend 01 auth、02 tenancy/users、03 metadicts/audit、04 master-data（含客戶專屬商品/檔案資產/QR 兌換）、05 sales-orders（後端 API＋狀態機＋取號）、09 printing 全數落地；06 returns、07 notifications、08 dispatch、fleet 未開工；frontend auth/users/UI 基礎完成、app 僅骨架；未部署**
