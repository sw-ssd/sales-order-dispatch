...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			logisticsdelivery.Table:      logisticsdelivery.ValidColumn,
			logisticsdeliveryevent.Table: logisticsdeliveryevent.ValidColumn,
			logisticsdriver.Table:        logisticsdriver.ValidColumn,
			logisticsproof.Table:         logisticsproof.ValidColumn,
