...
const (
	// Label holds the string label denoting the logisticsdriver type in the database.
	Label = "logistics_driver"
	...
	// Table holds the table name of the logisticsdriver in the database.
	Table = "logistics_drivers"
)

// Columns holds all SQL columns for logisticsdriver fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldDepartmentID,
...
// OrderOption defines the ordering options for the LogisticsDriver queries.
