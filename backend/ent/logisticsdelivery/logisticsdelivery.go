...
const (
	// Label holds the string label denoting the logisticsdelivery type in the database.
	Label = "logistics_delivery"
	...
	// Table holds the table name of the logisticsdelivery in the database.
	Table = "logistics_deliveries"
)

// Columns holds all SQL columns for logisticsdelivery fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldDepartmentID,
...
// OrderOption defines the ordering options for the LogisticsDelivery queries.
