...
// LogisticsDelivery 配送執行單元(D32/10.1):承接 route_id 的指派(粒度 = 車次,
...
// 邊與 driver userset tuple(見 internal/services/logistics_events.go)。
type LogisticsDelivery struct {
	ent.Schema
}

// Fields of the LogisticsDelivery.
func (LogisticsDelivery) Fields() []ent.Field {
	return []ent.Field{
...
// Indexes of the LogisticsDelivery.
func (LogisticsDelivery) Indexes() []ent.Index {
	return []ent.Index{
