...
func (_c *AuditLogCreate) SetCompanyID(v int) *AuditLogCreate {
	_c.mutation.SetCompanyID(v)
	return _c
}

// SetDepartmentID sets the "department_id" field.
func (_c *AuditLogCreate) SetDepartmentID(v int) *AuditLogCreate {
	_c.mutation.SetDepartmentID(v)
	return _c
}

// SetNillableDepartmentID sets the "department_id" field if the given value is not nil.
func (_c *AuditLogCreate) SetNillableDepartmentID(v *int) *AuditLogCreate {
	if v != nil {
...
func (_c *AuditLogCreate) SetBeforeSnapshot(v map[string]interface{}) *AuditLogCreate {
	_c.mutation.SetBeforeSnapshot(v)
	return _c
}

// SetAfterSnapshot sets the "after_snapshot" field.
func (_c *AuditLogCreate) SetAfterSnapshot(v map[string]interface{}) *AuditLogCreate {
...
func (_c *AuditLogCreate) check() error {
	if _, ok := _c.mutation.CompanyID(); !ok {
		return &ValidationError{Name: "company_id", err: errors.New(`ent: missing required field "AuditLog.company_id"`)}
	}
