...
const (
	// Label holds the string label denoting the promotag type in the database.
	Label = "promo_tag"
	...
	// Table holds the table name of the promotag in the database.
	Table = "promo_tags"
)

// Columns holds all SQL columns for promotag fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldDepartmentID,
...
// OrderOption defines the ordering options for the PromoTag queries.
