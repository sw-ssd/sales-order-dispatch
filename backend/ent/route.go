...
func (*Route) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case route.FieldID, route.FieldCompanyID, route.FieldDepartmentID, route.FieldSortOrder, route.FieldCreatedBy, route.FieldUpdatedBy:
			values[i] = new(sql.NullInt64)
		case route.FieldCode, route.FieldName, route.FieldDescription:
