...
type Permission struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Resource      string                 `protobuf:"bytes,1,opt,name=resource,proto3" json:"resource,omitempty"`                     // 資源(sales_order / customer / product / user / company / department / role / print / dispatch / accounting / return_request / notification)
